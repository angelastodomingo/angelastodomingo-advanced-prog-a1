...
class LetterCounter:
    def __init__(self, master):
        ...
        self.label = tk.Label(master, text="Enter a character:")
        self.label.pack()
    ...
    def count_occurrences(self):
        ...
        try:
            with open(file_path, 'r') as file:  #finds sentences.txt in the directory
                ...
                self.result_label.config(text=f"Occurrences of '{char_to_count}' in the file: {count}")
