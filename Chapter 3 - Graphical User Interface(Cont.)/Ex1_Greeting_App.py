...
name = tk.Entry(greeting, font=('Arial', 10), width=40,) 
name.place(x=40, y=100, width=300, height=60) #makes the entry box a bit larger
...
button.pack(anchor='w', padx=100, pady=30)
